...
import Vision.Area_cmd;
import Vision.CameraInitializer_cmd;
import Vision.CameraInterpreter_cmd;
import Vision.Height_cmd;
import Vision.Width_cmd;
import Vision.CenterX_cmd;
import Vision.CenterY_cmd;
...
public class Robot extends IterativeRobot {
	...
	Command CenterX_cmd;
	Command CenterY_cmd;
	Command CameraInitializer_cmd;
	Command CameraInterpreter_cmd;
	...
	public void robotInit() {
		...
		Height_cmd = new Height_cmd();
		Width_cmd = new Width_cmd();
		CenterX_cmd = new CenterX_cmd();
		CenterY_cmd = new CenterY_cmd();
		CameraInitializer_cmd = new CameraInitializer_cmd();
		CameraInterpreter_cmd = new CameraInterpreter_cmd();
...
//		chooser.addDefault("Default Auto", new Main_auto());
	...
	public void teleopPeriodic() {
		...
		CenterX_cmd.start();
		CenterY_cmd.start();
		CameraInitializer_cmd.start();
		CameraInterpreter_cmd.start();
		Scheduler.getInstance().run();
